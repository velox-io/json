...
static inline uint8_t *vj_seq_encode_int64(uint8_t *buf, const uint8_t *elem_ptr, uint32_t flags, int *nan_inf) {
  (void)flags;
  (void)nan_inf;
...
static inline uint8_t *vj_seq_encode_string(uint8_t *buf, const uint8_t *elem_ptr, uint32_t flags, int *nan_inf) {
  (void)nan_inf;
...
INLINE VjSeqResult vj_seq_iterate_impl(uint8_t *buf, const uint8_t *bend, const uint8_t *data, int64_t count,
                                       ...
                                       const int32_t elem_size, const int has_nan_check, vj_seq_encode_fn encode_one,
...
NOINLINE static VjSeqResult vj_seq_iterate_int(uint8_t *buf, const uint8_t *bend, const uint8_t *data, int64_t count,
                                               int32_t start_idx, uint32_t flags, const VjSeqIndent *ind) {
  return vj_seq_iterate_impl(buf, bend, data, count, start_idx, flags, ind, 8, 0, vj_seq_encode_int64,
                             vj_seq_need_int64);
}

NOINLINE static VjSeqResult vj_seq_iterate_int64(uint8_t *buf, const uint8_t *bend, const uint8_t *data, int64_t count,
                                                 int32_t start_idx, uint32_t flags, const VjSeqIndent *ind) {
  return vj_seq_iterate_impl(buf, bend, data, count, start_idx, flags, ind, 8, 0, vj_seq_encode_int64,
                             vj_seq_need_int64);
}

NOINLINE static VjSeqResult vj_seq_iterate_string(uint8_t *buf, const uint8_t *bend, const uint8_t *data, int64_t count,
                                                  int32_t start_idx, uint32_t flags, const VjSeqIndent *ind) {
