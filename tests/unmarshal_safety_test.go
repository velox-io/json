...
func TestArenaStringsSurviveGC(t *testing.T) {
	...
	for i, in := range inputs {
		if err := vjson.Unmarshal([]byte(in.json), &results[i]); err != nil {
...
func TestPointerFieldAllocation_GCStress(t *testing.T) {
	...
	for i := range N {
		...
		if err := vjson.Unmarshal(data, &results[i]); err != nil {
...
func TestPointer_PreExistingValue(t *testing.T) {
	...
	// Unmarshal new data
	err := vjson.Unmarshal([]byte(`{"data":{"id":42,"name":"updated"}}`), &s)
	if err != nil {
...
func TestPointer_PreExistingValue_PointerFree(t *testing.T) {
	...
	*existing = 999
	...
	err := vjson.Unmarshal([]byte(`{"v":42}`), &s)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestPointer_PreExistingValue_Null(t *testing.T) {
	...
	err := vjson.Unmarshal([]byte(`{"data":null}`), &s)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestPointer_StdlibCompat_NewAllocation(t *testing.T) {
	...
	if err := vjson.Unmarshal(input, &vjsonResult); err != nil {
...
func TestPointer_StdlibCompat_PreExisting(t *testing.T) {
	...
	if err := vjson.Unmarshal(input, &vjsonOuter); err != nil {
		t.Fatalf("vjson error: %v", err)
	}
...
func TestPointer_NestedPointers_PreExisting(t *testing.T) {
	...
	if err := vjson.Unmarshal(input, &existing); err != nil {
...
func TestPointer_PreExistingStackLikeValue(t *testing.T) {
	...
	for iter := range 500 {
		...
		if err := vjson.Unmarshal(data, &s); err != nil {
...
func TestPointer_PreExistingReuse_StdlibCompat(t *testing.T) {
	t.Run("*int", func(t *testing.T) {
		...
		*vjsonExisting = 0
		...
		if err := vjson.Unmarshal(input, &vjsonS); err != nil {
			t.Fatal(err)
		}
