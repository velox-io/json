...
func TestCopyTag_FieldLevel(t *testing.T) {
	...
	var v S
	if err := vjson.Unmarshal(buf, &v); err != nil {
		t.Fatal(err)
	}
...
func TestWithCopyString_Struct(t *testing.T) {
	...
	var v S
	if err := vjson.Unmarshal(input, &v, vjson.WithCopyString()); err != nil {
		t.Fatal(err)
	}
	if v.Name != "hello" {
...
func TestWithCopyString_MapStringString(t *testing.T) {
	...
	if err := vjson.Unmarshal(input, &m, vjson.WithCopyString()); err != nil {
		t.Fatal(err)
	}
...
func TestCopyString_Priority(t *testing.T) {
	...
	var v1 S
	if err := vjson.Unmarshal(input, &v1); err != nil {
		t.Fatal(err)
	}
	...
	var v2 S
	if err := vjson.Unmarshal(buf2, &v2, vjson.WithCopyString()); err != nil {
		t.Fatal(err)
	}
...
func TestDecoder_CopyString_Option(t *testing.T) {
	...
	dec := vjson.NewDecoder(strings.NewReader(`{"name":"hello"}`), vjson.DecoderCopyString())
...
func TestDecoder_CopyString_Method(t *testing.T) {
	...
	dec := vjson.NewDecoder(strings.NewReader(`{"name":"hello"}`))
	dec.CopyString()
...
func TestCopyString_WithUseNumber(t *testing.T) {
	...
	var v S
	if err := vjson.Unmarshal(input, &v, vjson.WithCopyString(), vjson.WithUseNumber()); err != nil {
		t.Fatal(err)
	}
