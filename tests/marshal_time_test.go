...
func TestMarshal_TimeTime_Slice(t *testing.T) {
	...
	vjData, err := vjson.Marshal(times)
	if err != nil {
		t.Fatalf("marshal: %v", err)
	}
	...
	// Empty slice
	empty := []time.Time{}
	vjData, err = vjson.Marshal(empty)
	if err != nil {
	...
	vjData, err = vjson.Marshal(nilSlice)
	if err != nil {
...
func TestMarshal_TimeTime_Indent(t *testing.T) {
	...
	vjData, err := vjson.MarshalIndent(ev, "", "  ")
	if err != nil {
	...
	vjData, err = vjson.MarshalIndent(times, "", "\t")
	if err != nil {
...
func TestMarshal_TimeTime_Omitempty(t *testing.T) {
	...
	vjData, err = vjson.Marshal(nonZero)
	if err != nil {
