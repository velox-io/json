...
const compatResultsPath = "../JSONTestSuite/compat_results.json"
...
func TestJSONTestSuiteCompatibility(t *testing.T) {
	...
	want.GotPassingWantFailing = append(want.GotPassingWantFailing, backendGotPassingWantFailing...)
	want.GotFailingWantPassing = append(want.GotFailingWantPassing, backendGotFailingWantPassing...)
	want.normalize()
