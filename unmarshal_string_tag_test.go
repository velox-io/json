...
func TestUnmarshal_StringTag_Int(t *testing.T) {
	var v StringTagInt
	if err := Unmarshal([]byte(`{"count":"123"}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.Count != 123 {
...
func TestUnmarshal_StringTag_NegativeInt(t *testing.T) {
	var v StringTagInt
	if err := Unmarshal([]byte(`{"count":"-42"}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.Count != -42 {
...
func TestUnmarshal_StringTag_Int64(t *testing.T) {
	...
	if err := Unmarshal([]byte(`{"count":"9007199254740993"}`), &v); err != nil {
		t.Fatal(err)
	}
...
func TestUnmarshal_StringTag_Uint(t *testing.T) {
	var v StringTagUint
	if err := Unmarshal([]byte(`{"count":"456"}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.Count != 456 {
...
func TestUnmarshal_StringTag_Bool(t *testing.T) {
	var v StringTagBool
	if err := Unmarshal([]byte(`{"flag":"true"}`), &v); err != nil {
		t.Fatal(err)
	}
	if !v.Flag {
	...
	if err := Unmarshal([]byte(`{"flag":"false"}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.Flag {
...
func TestUnmarshal_StringTag_Float(t *testing.T) {
	...
	if err := Unmarshal([]byte(`{"rate":"1.5"}`), &v64); err != nil {
		t.Fatal(err)
	}
	if v64.Rate != 1.5 {
	...
	if err := Unmarshal([]byte(`{"rate":"2.25"}`), &v32); err != nil {
		t.Fatal(err)
	}
	if v32.Rate != 2.25 {
...
func TestUnmarshal_StringTag_String(t *testing.T) {
	...
	if err := Unmarshal([]byte(`{"name":"\"hello\""}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.Name != "hello" {
...
func TestUnmarshal_StringTag_Pointer(t *testing.T) {
	...
	var v2 StringTagPtr
	if err := Unmarshal([]byte(`{"ptr":null}`), &v2); err != nil {
		t.Fatal(err)
	}
	if v2.Ptr != nil {
...
func TestStringTag_StdlibCompat_Unmarshal(t *testing.T) {
	...
	for _, input := range tests {
		...
		vjsonErr := Unmarshal([]byte(input), &vjsonV)
