...
// OpType ↔ typ.ElemTypeKind alignment + kindToOpcode

func TestPrimitiveOpTypeAlignedWithElemTypeKind(t *testing.T) {
	// Primitive opcodes 1-14 must equal the corresponding typ.ElemTypeKind.
	checks := []struct {
		kind typ.ElemTypeKind
		op   uint16
		name string
	}{
		{typ.KindBool, opBool, "Bool"},
		{typ.KindInt, opInt, "Int"},
		{typ.KindInt8, opInt8, "Int8"},
		{typ.KindInt16, opInt16, "Int16"},
		{typ.KindInt32, opInt32, "Int32"},
		{typ.KindInt64, opInt64, "Int64"},
		{typ.KindUint, opUint, "Uint"},
		{typ.KindUint8, opUint8, "Uint8"},
		{typ.KindUint16, opUint16, "Uint16"},
		{typ.KindUint32, opUint32, "Uint32"},
		{typ.KindUint64, opUint64, "Uint64"},
		{typ.KindFloat32, opFloat32, "Float32"},
		{typ.KindFloat64, opFloat64, "Float64"},
		{typ.KindString, opString, "String"},
	}
...
func TestKindToOpcode(t *testing.T) {
	...
	checks := []struct {
		...
		{typ.KindInt, opInt, "Int"},
		{typ.KindString, opString, "String"},
		{typ.KindAny, opInterface, "Any/Interface"},
		{typ.KindRawMessage, opRawMessage, "RawMessage"},
		{typ.KindNumber, opNumber, "Number"},
	}
	for _, c := range checks {
