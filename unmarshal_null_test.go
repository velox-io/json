...
func TestNull_StructUnchanged(t *testing.T) {
	...
	if err := Unmarshal([]byte(`{"A":null,"B":"after"}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.A.X != 42 {
...
func TestNull_PointerSetNil(t *testing.T) {
	...
	v := S{PI: &n, PS: &s}
	if err := Unmarshal([]byte(`{"PI":null,"PS":null}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.PI != nil {
...
func TestNull_SliceSetNil(t *testing.T) {
	...
	if err := Unmarshal([]byte(`{"A":null,"B":null}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.A != nil {
...
func TestNull_MapSetNil(t *testing.T) {
	...
	if err := Unmarshal([]byte(`{"M":null}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.M != nil {
...
func TestNull_InterfaceSetNil(t *testing.T) {
	...
	v := S{V: "something"}
	if err := Unmarshal([]byte(`{"V":null}`), &v); err != nil {
		t.Fatal(err)
	}
	if v.V != nil {
