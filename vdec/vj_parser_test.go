...
import (
	...
	. "github.com/velox-io/json/vdec" //nolint:revive // dot-import for test readability
)
...
func TestRoundtrip_MapNetIPKey(t *testing.T) {
	...
	data, err := vjson.Marshal(entries)
	if err != nil {
		t.Fatalf("marshal error: %v", err)
	}
...
func TestMarshal_TimeTime_StdlibCompat(t *testing.T) {
	...
	for _, ts := range times {
		vjsonData, err := vjson.Marshal(ts)
		if err != nil {
